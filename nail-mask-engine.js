export class NailMaskEngine {
  ...
  async refineWithAiMask(video, fallback) {
    ...
    try {
      ...
      const mobileAttachNudge = window.matchMedia?.("(max-width: 900px)")?.matches ? 0.014 : 0.008;
      ...
      return {
        ...
        rootX: (displayCenterX - axisX * (heightPct / 100) * 0.31) * 100,
        rootY: (displayCenterY - axisY * (heightPct / 100) * 0.31) * 100,
        axisX,
        axisY,
        widthPct,
        heightPct,
  ...
  refineFingerEstimate(landmarks, fallback, index) {
    ...
    return {
      ...
      x: displayCenterX * 100,
      y: displayCenterY * 100,
      rootX: (displayCenterX - displayAxisX * (heightPct / 100) * 0.31) * 100,
      rootY: (displayCenterY - displayAxisY * (heightPct / 100) * 0.31) * 100,
      axisX: displayAxisX,
      axisY: displayAxisY,
      widthPct,
      heightPct,
